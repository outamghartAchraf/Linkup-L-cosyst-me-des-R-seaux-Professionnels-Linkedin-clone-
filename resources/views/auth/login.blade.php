    ...
    <div class="w-full max-w-5xl bg-white rounded-3xl overflow-hidden shadow-2xl shadow-slate-300/40 grid lg:grid-cols-2">
        ...
        <div class="p-6 sm:p-10 flex flex-col">
            ...
            @if(session('status'))
                ...
                <div class="mb-5 rounded-2xl bg-emerald-50 border border-emerald-200 p-4 flex gap-3 text-emerald-700">

                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
