<article
    ...
    <div class="mb-3 flex items-start gap-3">
        ...
        {{-- Avatar --}}
        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-blue-100/70 font-semibold text-sm text-blue-700 ring-2 ring-blue-50">
            ...
            @if($post->user->image_url)
                ...
                <a href=" ">
                    ...
                    <img
                        src="{{ asset('storage/'.$post->user->image_url) }}"
            ...
            @else
                ...
                <a href=" ">
                    ...
                    <div class="flex h-11 w-11 items-center justify-center rounded-full bg-blue-100 text-blue-700 font-semibold">
